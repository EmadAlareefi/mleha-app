...
const serviceCategoryMap: Partial<Record<ServiceKey, DashboardCategoryId>> = {
  ...
  'notify-script-editor': 'store',
  'salla-product-reviews': 'store',
  'salla-size-guides': 'store',
...
const serviceIconMap: Partial<Record<ServiceKey, LucideIcon>> = {
  ...
  'salla-product-search': PackageSearch,
  ...
  'notify-script-editor': Code2,
  'salla-product-reviews': Star,
  'salla-size-guides': Ruler,
  expenses: Wallet,
