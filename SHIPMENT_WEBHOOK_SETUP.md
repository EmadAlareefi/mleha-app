...
8. ✅ **PrintNode** prints the label on device 75062490
...
3. Check server logs:
   ...
   ```
4. Verify label prints on device 75062490
...
3. **Verify device online:**
   ```bash
  curl https://api.printnode.com/computers/75062490 \
     -u qnwXXDzp3JhLS5w1bBWy_F9aIWZgSys1LtMNN4tQcbU:
   ```
