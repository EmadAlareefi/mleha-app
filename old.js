...
(function () {
    ...
    var WIDGETS = [
      {
        id: 'mleha-notify-me-loader',
        src: API_BASE + '/embed/notify-me.js'
      },
      {
        id: 'mleha-product-reviews-loader',
        src: API_BASE + '/embed/product-reviews.js'
      }
    ];
    ...
    function isSingleProductPage() {
      try {
        if (
          window.salla &&
          window.salla.url &&
          typeof window.salla.url.is_page === 'function' &&
          window.salla.url.is_page('product.single')
        ) {
          return true;
        }
    ...
    function start() {
      if (window.salla && typeof window.salla.onReady === 'function') {
        window.salla.onReady(loadWidgets);
      } else {
        window.addEventListener('salla::created', loadWidgets, {
          once: true
        });
      }
    }
  ...
  const sectionConfigs = [
      ...
      items: [
        {
          ...
          text: 'تصاميم تم اختيارها بعناية.',
          link: 'اكتشفي الجديد'
        },
        {
          title: 'فساتين السهرة',
          text: 'نتميز بفخامة الفساتين.',
          link: 'شاهدي التشكيلة'
        }
      ]
    },
    {
      ...
      items: [
        {
          title: 'فساتين ناعمه',
          text: 'موديلات ناعمه دايماً مميزه.',
          link: 'شاهدي التشكيلة'
        },
        {
          title: 'اوتلت مليحة',
          text: 'تصفية على آخر القطع.',
          link: 'تسوّقي الأوتلت'
        }
      ]
    }
...
onReady(function formatReviewNames() {
  document
    .querySelectorAll('.s-block--custom-reviews h4')
    .forEach((el) => {
      ...
      const name = original.slice(0, separator);
      const city = original.slice(separator + 3);
      ...
      citySpan.className = 'review-city';
      citySpan.textContent = city;

      el.replaceChildren(nameSpan, citySpan);
    });
});
...
const mlehaLocalizationLabel = isMlehaEnglish ? "Language & Currency" : "اللغة والعملة";
  ...
  <ul class="footer-list">
    ...
    <li>
        ...
        <div class="mleha-footer-column mleha-footer-social">
          ...
          <div class="mleha-settings-container">
            <button
              ...
              aria-label="${mlehaLocalizationLabel}"
            >
              <i class="sicon-earth"></i>
              <span>${mlehaLocalizationLabel}</span>
      ...
      <div class="mleha-footer-certificates">
        ...
        <!-- VAT Certificate -->
        <a
          href="https://drive.google.com/file/d/1cSIYOxmlIelQER3hdR18fgZsFT9uHJUU/view?usp=sharing"
          target="_blank"
          class="mleha-cert-card"
        >
          <img
