...
export default function ReturnsPage() {
  ...
  const [exchangeWindowExpiredProductIds, setExchangeWindowExpiredProductIds] = useState<string[]>([]);
  ...
  const handleLookupOrder = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!returnsResponse.ok) {
        ...
        if (returnsData.errorCode === 'DISCOUNTED_CATEGORY_NOT_RETURNABLE') {
          setErrorDetails({
            title: 'الطلب غير مؤهل للإرجاع أو الاستبدال',
            message: returnsData.message || returnsData.error,
            variant: 'error',
          });
          setErrorDialogOpen(true);
      ...
      setExchangeWindowExpiredProductIds(
        Array.isArray(returnsData.exchangeWindowExpiredProductIds)
          ? returnsData.exchangeWindowExpiredProductIds
          : []
      );
          ...
          <Card className="p-8">
            ...
            <div className="mt-8 pt-6 border-t">
              ...
              <ul className="list-disc list-inside space-y-1 text-sm text-gray-600">
                ...
                <li>يتم الاستبدال خلال (3) أيام من تاريخ استلام الطلبية.</li>
              </ul>
            </div>
          </Card>
        )}
        ...
        {step === 'form' && order && (
          <div>
            ...
            <ReturnForm
              ...
              exchangeWindowExpiredProductIds={exchangeWindowExpiredProductIds}
