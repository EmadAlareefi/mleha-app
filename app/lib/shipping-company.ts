...
export const getShippingAddressSummary = (orderData: unknown): ShippingAddressSummary => {
  ...
  const candidateSources = [
    ...
    rootShipping?.ship_to,
    rootShipping?.shipTo,
    rootShipping?.receiver,
    rootShipping?.destination,
    rootShipping?.shipment && asRecord(rootShipping.shipment)?.ship_to,
    rootShipping?.shipment && asRecord(rootShipping.shipment)?.shipTo,
    rootShipping?.shipment && asRecord(rootShipping.shipment)?.receiver,
    rootDelivery?.address,
    rootDelivery?.shipping_address,
    rootDelivery?.shippingAddress,
    rootDelivery?.ship_to,
    rootDelivery?.shipTo,
    ...
    nestedShipping?.ship_to,
    nestedShipping?.shipTo,
    nestedShipping?.receiver,
    nestedDelivery?.address,
    nestedDelivery?.ship_to,
    nestedDelivery?.shipTo,
    nestedDelivery?.receiver,
    nestedOrder?.ship_to,
    nestedOrder?.shipTo,
    nestedOrder?.receiver,
